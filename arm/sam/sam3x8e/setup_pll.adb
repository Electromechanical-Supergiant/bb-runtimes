...
with Interfaces.SAM3X8E.EFC;    use Interfaces.SAM3X8E.EFC;
with Interfaces.SAM3X8E.PMC;    use Interfaces.SAM3X8E.PMC;
with Interfaces.SAM3X8E.SYSC;   use Interfaces.SAM3X8E.SYSC;

procedure Setup_Pll is
   CKGR_MOR : CKGR_MOR_Register;
   CKGR_MOR_KEY_VALUE : constant
                         Interfaces.SAM3X8E.PMC.CKGR_MOR_KEY_Field := 16#37#;
begin
